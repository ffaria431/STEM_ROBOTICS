...
img_size = 50
num_channels = 3
train_path='/Users/shaikat/Documents/OpenCV/Traindata'
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, '/Users/shaikat/Documents/OpenCV/Hand-Gesture-Recognition-Using-CNN-master/handgest_1') 
