...
saver = tf.train.import_meta_graph('/Users/shaikat/Documents/OpenCV/Hand-Gesture-Recognition-Using-CNN-master/handgest_1.meta')
# Step-2: Now let's load the weights saved using the restore method.
saver.restore(sess, tf.train.latest_checkpoint('/Users/shaikat/Documents/OpenCV/Hand-Gesture-Recognition-Using-CNN-master'))
